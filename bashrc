...
__prompt_command() {
    ...
    # Add git repo information
    PS1+=' \w $(__git_ps1 "(\[\e[4;32m\]%s\[\e[00m\]\[\e[0;32m\])")\[\e[00m\]'
...
# Export inovor paths
SPACECRAFT_DIR=~/spacecraft
CPPUTEST_HOME=~/repositories/testframeworks/cpputest
export SPACECRAFT_DIR
